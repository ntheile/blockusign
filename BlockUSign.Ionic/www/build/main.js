...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models_state__ = __webpack_require__(562);
...
var DocumentService = (function () {
    ...
    function DocumentService(events, http) {
        var _this = this;
        this.events = events;
        this.http = http;
        this.indexFileName = "blockusign/documents.index.json";
        this.state = new __WEBPACK_IMPORTED_MODULE_8__models_state__["a" /* State */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__services_blockstack_service__ = __webpack_require__(99);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_blockstack_service__ = __webpack_require__(99);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 8:
                        ...
                        setTimeout(function () {
                            _this.documentService.mergeAnnotations(_this.navParams.get("guid"));
                        }, 3000);
                        return [2 /*return*/];
                }
            });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_blockstack_service__ = __webpack_require__(99);
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen, loadingCtrl, alertCtrl, documentService, popoverCtrl, menuCtrl, blockStackService) {
    ...
    MyApp.prototype.showProfile = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!blockstack.isUserSignedIn()) return [3 /*break*/, 3];
                        ...
                        if (!!profile.username) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.blockStackService.getEmail()];
                    case 1:
                        profileData = _a.sent();
                        if (!profileData) {
        ...
        var alert = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        // save here
                        _this.blockStackService.setEmail(data.email);
                        if (true) {
                            // logged in!
                        }
                        else {
...
var BlockStackService = (function () {
    ...
    BlockStackService.prototype.getEmail = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    BlockStackService.prototype.setEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var json;
            return __generator(this, function (_a) {
                switch (_a.label) {
